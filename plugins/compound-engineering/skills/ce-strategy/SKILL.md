...
If no specific target, ask the user which section to revisit using the blocking question tool (`AskUserQuestion`, `request_user_input`, `ask_user`, or `clarify`). Options:
